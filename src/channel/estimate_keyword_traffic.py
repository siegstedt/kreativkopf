...
def DisplayEstimate(message, min_estimate, max_estimate):
  ...
  print(message)
  print('  Estimated average CPC:', _FormatMean((mean_avg_cpc/1000000 if mean_avg_cpc else None )), 'EUR')
  print('  Estimated ad position:', _FormatMean(mean_avg_pos))
  print('  Estimated daily clicks:', _FormatMean(mean_clicks))
  print('  Estimated daily cost:', _FormatMean((mean_total_cost/1000000 if mean_total_cost else None)), 'EUR')
